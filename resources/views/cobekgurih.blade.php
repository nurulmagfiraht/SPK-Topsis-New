...
<head>
  ...
  <title>Cobek Gurih</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="/img/icon-cg.png" rel="icon">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
            ...
            <p>Spesialis Nasi Dos dan Prasmanan</p>
            <div class="d-flex">
          ...
          <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="200">
            <img src="/img/cobekgurih.png" class="img-fluid animated" alt="">
          </div>
        </div>
      </div>
    ...
    <section id="about" class="about section">
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-15 content text-center" data-aos="fade-up" data-aos-delay="100">
            <p>
              Cobek Gurih merupakan salah satu brand dari PT. Tritama Nusantara Haromain yang berfokus pada
              bidang Food & Beverage. Cobek Gurih berdiri sejak tahun 2019. 
            </p>
          </div>
